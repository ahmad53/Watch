...
import com.task.watch.databinding.FragmentMovieListBinding
import com.task.watch.db.PreferencesStorage
import com.task.watch.utils.RecyclerViewDecoration
        ...
        searchView.apply {
            ...
            setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                ...
                override fun onQueryTextChange(newText: String?): Boolean {
                    movieListViewModel.query = newText
                    getMovieList()
                    return true
                }
